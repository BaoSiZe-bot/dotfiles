...
pacman="sudo pacman --noconfirm --needed"
yay="paru --noconfirm --needed"
...
basic_packages=(
  hyprland-git hyprpaper-git hyprlock-git waybar-git mako xorg-xwayland
  kitty-git nm-connection-editor
  xdg-desktop-portal-hyprland-git grim
  ...
  # Some GUI software
  thunar ristretto thunderbird okular wezterm-git
